...
Визуализация показывает, что во вспомогательной задаче надо искать преобразование (x,y)=>(x+a*y,y)  с последующим сдвигом и растяжение так, чтобы диапазон координат **x** оставался прежним, а минимальное из взаимныъ расстояний между точками было максимальным.
...
## [drawImage](https://a402539.github.io/triangulation/drawImage.html) Преобразование изображений с сохранением соотвествия точек
